...
function MenuElemaniOlustur(arg1, arg2, arg3){
...
function DegerledirmeEkle(arr, name, score, comment){
	const degerlendirme = {isim: name, puan: score, geribildirim: comment};
	arr.push(degerlendirme);
	return arr;
}
